...
void PreferenceDialog::createWebBroserPage()
{
	webBrowserPage = new QWidget(this);
...
{
	mailAndNewsPage = new QWidget(this);
...
void PreferenceDialog::createAdvancedPage()
{
	...
	ftpLineEdit = new QLineEdit(this);
